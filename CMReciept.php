  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="/PolomolokPublicMarket/Receipts/issueRe.php" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
...
function fetchReceiptHistory(vendorId) {
  ...
  xhr.open('GET', '/PolomolokPublicMarket/Receipts/get_receipts.php?vendor_id=' + vendorId, true); // Add vendor_id to the query
  xhr.onload = function() {
