...
if (isset($_GET['stall_no'])) {
    ...
    $stmt = $conn->prepare("
        SELECT building_e.stall_status, vendors.first_name, vendors.middle_name, vendors.last_name
        FROM building_e
        LEFT JOIN vendors ON building_e.vendor_id = vendors.vendor_id
        WHERE building_e.stall_no = ?
    ");
