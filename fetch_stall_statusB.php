...
if (isset($_GET['stall_no'])) {
    ...
    $stmt = $conn->prepare("
        SELECT building_b.stall_status, vendors.first_name, vendors.middle_name, vendors.last_name
        FROM building_b
        LEFT JOIN vendors ON building_b.vendor_id = vendors.vendor_id
        WHERE building_b.stall_no = ?
    ");
