    ...
    <div class="container-fluid py-4">
      ...
      <div class="row mt-4">
        <div class="col-lg-5 mb-lg-4 mb-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-lg text-info mb-3 text-start mx-2">Admin Profile</h5>
              <div class="row">
                <div class="col-md-4">
                  <?php
                  // Check if the user has a profile picture set; if not, use a default image
      ...
      <div class="accordion" id="profile-accordion">
        ...
        <div class="accordion-item">
          <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
            data-bs-parent="#profile-accordion">
            <div class="accordion-body">
              <form id="uploadForm" action="adminPicUpload.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
