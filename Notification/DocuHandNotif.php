...
$sql = "SELECT * FROM notifications WHERE user_type = 'Document Handler' AND is_read = 0 ORDER BY time_stamp DESC LIMIT 5";
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    switch (notificationType) {
                        case 'New Document Upload':
                            window.location.href = 'DHMVendorDocuments.php';
                            break;
