  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed active" href="#" data-bs-toggle="collapse" data-bs-target="#collapseMaps" aria-expanded="false" aria-controls="collapseMaps">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Maps</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Building E</h6>
        </nav>
          ...
          <div class="card z-index-2">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold">Building E</span>
              </p>  
            </div>
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg ">
      ...
      <div class="card-body pt-sm-3 pt-0">
        <a class="btn bg-gradient-info w-80 text-white" href="#">Edit Profile</a>
        <a class="btn btn-outline-info w-80" href="index.php">Logout</a>
        <hr class="horizontal dark my-1">
