...
if (isset($_GET['stall_no'])) {
    ...
    $stmt = $conn->prepare("
        SELECT building_i.stall_status, vendors.first_name, vendors.middle_name, vendors.last_name
        FROM building_i
        LEFT JOIN vendors ON building_i.vendor_id = vendors.vendor_id
        WHERE building_i.stall_no = ?
    ");
