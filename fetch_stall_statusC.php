...
if (isset($_GET['stall_no'])) {
    ...
    $stmt = $conn->prepare("
        SELECT building_c.stall_status, vendors.first_name, vendors.middle_name, vendors.last_name
        FROM building_c
        LEFT JOIN vendors ON building_c.vendor_id = vendors.vendor_id
        WHERE building_c.stall_no = ?
    ");
