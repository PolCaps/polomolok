...
<div class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addVendorApplicant">Add
        Vendor Applicant</button>
      <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete Rejected
        Applicants</button>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form id="customDateForm" method="POST">
                              ...
                              <input type="text" id="customEndDate" name="end_date" class="form-control"
