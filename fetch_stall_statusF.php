...
if (isset($_GET['stall_no'])) {
    ...
    $stmt = $conn->prepare("
        SELECT building_f.stall_status, vendors.first_name, vendors.middle_name, vendors.last_name
        FROM building_f
        LEFT JOIN vendors ON building_f.vendor_id = vendors.vendor_id
        WHERE building_f.stall_no = ?
    ");
