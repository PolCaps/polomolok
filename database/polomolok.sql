...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2024 at 02:03 PM
...
(1, 'A-01', 'Ground Floor', '3,060.00', 80, 'Occupied', NULL, NULL, NULL),
(2, 'A-02', 'Ground Floor', '5,400.00', 83, 'Occupied', NULL, NULL, NULL),
(3, 'A-03', 'Ground Floor', '5,400.00', 0, 'Vacant', '0000-00-00', '0000-00-00', ''),
(4, 'A-04', 'Ground Floor', '5,400.00', 88, 'Vacant', '2024-10-22', '2025-01-22', 'Due Quarterly'),
(5, 'A-05', 'Ground Floor', '5,400.00', 89, 'Vacant', '0000-00-00', '1971-01-01', 'Due Yearly'),
(6, 'A-06', 'Ground Floor', '3,060.00', 90, 'Vacant', '2024-10-22', '2025-10-22', 'Due Yearly'),
(7, 'A-07', 'Ground Floor', '2,345.00', 91, 'Vacant', '2024-10-22', '2025-01-22', 'Due Quarterly'),
(8, 'A-08', 'Ground Floor', '2,345.00', 84, 'Occupied', NULL, NULL, NULL),
(9, 'A-09', 'Ground Floor', '5,265.00', 98, 'Occupied', '2024-10-22', '2025-10-22', 'Due Yearly'),
...
(1, 'B-01', 'Ground Floor', '2,025.00', 82, 'Occupied', NULL, NULL, NULL),
(2, 'B-02', 'Ground Floor', '2,025.00', NULL, 'Vacant', NULL, NULL, NULL),
...
(15, 'B-15', 'Ground Floor', '2,025.00', 83, 'Occupied', NULL, NULL, NULL),
...
(89, 'C-87', 'Second Floor', '3,600.00', NULL, '', NULL, NULL, NULL),
...
(16, 'D-16', 'Ground Floor', '2,475.00', 86, 'Occupied', NULL, NULL, NULL),
...
(6, 'G-06', 'Ground Floor', '950.00', 85, 'Occupied', NULL, NULL, NULL),
...
(68, 'I-68', 'Ground Floor', '1,640.00', 68, 'Occupied', NULL, NULL, NULL),
...
(2, 'J-02', 'Ground Floor', '5,400.00', 92, 'Vacant', '2024-10-22', '2024-10-26', 'Due Monthly'),
(3, 'J-03', 'Ground Floor', '5,400.00', 93, 'Vacant', '2024-10-22', '2024-12-18', 'Due Monthly'),
(4, 'J-04', 'Ground Floor', '5,400.00', 94, 'Occupied', '2024-10-22', '2024-10-21', 'Due Monthly'),
...
(114, 'J-114', 'Second Floor', '700.00', 67, 'Occupied', NULL, NULL, NULL),
...
(14, 92, 'datas//2024-10-22/Statement of Account.pdf', 'datas//2024-10-22/SayrePrince_PDF.pdf', 'datas//2024-10-22/ITSM_SAYRE.pdf', NULL);
...
('ACTIVE', 92, 'sample', 'sample123', 'Localhost', 'S', 'Error', 27, 'sayre residence purok darussalam bawing', 'localhost@gmail.com', '9171600383', '2024-10-22', 'MONTHLY'),
('ACTIVE', 93, 'coalecse', 'coalecse123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-22', 'MONTHLY'),
('ACTIVE', 94, 'Obir', 'wan123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-22', 'MONTHLY'),
('ACTIVE', 96, 'yearlyTry', 'yearlyTryyearlyTry', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-22', 'YEARLY'),
('ACTIVE', 97, 'Yerrrr', 'YerrrrYerrrr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-22', 'YEARLY'),
('ACTIVE', 98, 'yearrr', 'yearrryearrr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-22', 'YEARLY');
...
CREATE TABLE `vendorsoa` (
  ...
  `miscellaneous_fees` varchar(255) DEFAULT NULL,
...
INSERT INTO `vendorsoa` (`id`, `vendor_id`, `username`, `message`, `remaining_balance`, `monthly_rentals`, `miscellaneous_fees`, `other_fees`, `total_amount`, `date`, `file_path`) VALUES
(5, 55, 'jp', NULL, '1566', '3060', '700', '666', '5992', '2024-09-01', 'invoice/invoice_jp.pdf'),
(6, 56, 'james', NULL, '4500', '5400', '0', '0', '9900', '2024-09-01', 'invoice/invoice_james_2024-09-01.pdf'),
(7, 57, 'meedo', NULL, '5400', '5400', '0', '0', '10800', '2024-09-01', 'invoice/invoice_meedo_2024-09-01.pdf'),
(8, 80, 'vendor1', NULL, '100', '3060', '0', '0', '3160', '2024-09-30', 'invoice/invoice_vendor1_2024-09-30.pdf'),
(9, 82, 'vendorbuildinge', NULL, '1300', '2025', '1200', '0', '4525', '2024-09-29', 'invoice/invoice_vendorbuildinge_2024-09-29.pdf'),
(10, 83, 'reyan', NULL, '0', '5400', '0', '0', '5400', '2024-09-30', 'invoice/invoice_reyan_2024-09-30.pdf'),
(11, 84, 'briar', NULL, '300', '2345', '0', '0.01', '2645.01', '2024-10-02', 'invoice/invoice_briar_2024-10-02.pdf'),
(12, 92, 'sample', 'Hello, This is to remind you that you have an upcoming due on October 26, 2024.', '0.01', '5400', '0', '0', '5400.01', '2024-10-22', 'invoice/invoice_sample_2024-10-22.pdf');
...
--
ALTER TABLE `vendors`
  MODIFY `vendor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
