...
$inquiriesQuery = "SELECT COUNT(*) AS inquiryCount, name, email_add AS email, subject, message, sent_date 
                   FROM inquiry 
...
<div class="container-fluid py-2">
    <div class="row my-4">
         ...
         <div class="col-lg-4 col-md-6 mb-md-0 mb-6">
            <div class="card">
