...
if (isset($_GET['stall_no'])) {
    ...
    $stmt = $conn->prepare("
        SELECT building_d.stall_status, vendors.first_name, vendors.middle_name, vendors.last_name
        FROM building_d
        LEFT JOIN vendors ON building_d.vendor_id = vendors.vendor_id
        WHERE building_d.stall_no = ?
    ");
