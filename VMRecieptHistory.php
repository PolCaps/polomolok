        ...
        <div class="container-fluid py-4">
          ...
          <div class="row my-4">
            <div class="col-lg-11 col-md-6 mb-md-0 mb-4">
              ...
              <div class="row">
                <h6 class="text-center"><span class="text-sm text-secondary">Vendor Name:</span> Prince Jay Sayre PHP</h6>
              </div>
            </div>
                    ...
                    <table class="table align-items-center mb-0">
                      ...
                      <tbody id="dataTableBody">
                        <tr>
                          ...
                          <td class="align-middle text-center text-sm">Building J</td>
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center text-sm">Building K</td>
